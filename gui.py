...
class GUI:
    def __init__(self, select_folder, start_transcribe_thread, end_transcribe_thread):
        ...
        self.console_output.grid(row=5, column=0, sticky=tk.N, pady=15, padx=(15, 0))
        ...
        self.start_transcribe_button.grid(row=6, column=0, sticky=tk.W, padx=(200, 0))
        ...
        self.stop_transcribe_button.grid(row=6, column=0, sticky=tk.E, padx=(0, 200))
